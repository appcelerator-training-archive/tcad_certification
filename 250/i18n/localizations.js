...
String.toLocaleString({
	"en-US": {
		...
		"%l_slidenote_solution": "Walk through – TiBH250<br><u>app.js</u><ul><li>new included file</li></ul><u>db.js</u><ul><li>DB open, create table, and close statements</li><li>list()</li><li>ternary operator</li><li>add() - not application level event</li><li>delete()</li><li>bust()</li></ul>"
	}
});
