...
String.toLocaleString({
	"en-US": {
		...
		"%l_slidenote_android_dep_release": "Steps of Android release process – don’t go into depth here",
		...
		"%l_slidenote_android_market_reqs": "Need a Google account (Gmail, Google Docs)<br>Sign up at market.android.com/publish<br>One-time $25 fee<br>Need an Google Checkout Account if you’ll be selling your app for a fee<br>Use SDK tools to sign and verify APK file",
		"%l_gen_key_pair": "Generate key pair and certificate",
		"%l_slidenote_gen_key_pair": "Point out highlighted keytool command<br>Alias varies and is specific to your app<br>Can store multiple certificates in the same keystore<br>Make backup copies of your keystore file and save in safe location",
		"%l_verify_keystore": "Verify keystore",
		"%l_slidenote_verify_keystore": "Point out keytool command<br>Want to see “Valid from” and date 25 years from now or longer",
		"%l_sign_app": "Sign your application",
		"%l_slidenote_sign_app": "From Deploy menu, choose Distribute – Android<br>You’ll specify your keystore location, password, and alias",
		"%l_verify_signed": "Verify signed app",
		"%l_slidenote_verify_signed": "Use Jarsigner to verify apk file<br>Looking for “jar verified”<br>Might need to use zipalign tool. Android.com site will inform you if you do.<br>Shouldn’t be needed after Titanium 1.4",
		...
		"%l_ios_install_profile": "Install the provisioning profile",
		...
		"%l_slidenote_validate_upload": "Xcode organizer, Archives window<br>Validate app – checks for app in iTunes Connect, required graphic assets, signing, etc.<br>Upload using the Application Loader (in Developer/Applications/Utilities folder)",
		"%l_app_store_reqs": "App Store Requirements",
		"%l_many_reqs": "Many requirements – see iOS Dev Center for full details",
