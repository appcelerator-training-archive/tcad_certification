...
String.toLocaleString({
	"en-US": {
		...
		"%l_layoutmethod2v2": "Call <code>applyProperties()</code> to batch changes",
		"%l_layoutmethod3v2": "(<code>startLayout()</code> and <code>finishLayout()</code> are now deprecated)",
